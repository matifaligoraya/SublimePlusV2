...
add_action('tgmpa_register', 'sublimeplus_register_required_plugins');

/**
 * Register the required plugins for this theme.
 */
if (!function_exists('sublimeplus_register_required_plugins')) {
    function sublimeplus_register_required_plugins()
    {
        /*
         * Array of plugin arrays. Required keys are name and slug.
         * If the source is NOT from the .org repo, then source is also required.
         */
        $SUBLIMEPLUS_DIRectory_plugins = get_template_directory() . '/inc/plugins/';
        $plugins = array(
            // array(
            //     'name' => esc_html__('Clever Addons', 'sublimeplus'),
            //     'slug' => 'clever-addons',
            //     'required' => true,
            //     'source' => $SUBLIMEPLUS_DIRectory_plugins . 'clever-addons.zip',
            //     'version' => '1.0.0'
            // ),
			// array(
