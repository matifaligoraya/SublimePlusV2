...
(function ($) {
    ...
    jQuery(document).ready(function ($) {
        ...
        //Mobile Menu
        $(document).on('click', '.menu-item:not(.is-mega-menu) .sublimeplus-icon-down', function (e) {
        ...
        $(document).on('click', '.is-mega-menu>a>.sublimeplus-icon-down', function (e) {
            if($(window).width()<1024.98) {
                if (e.target !== this)
                    return;
                else {
        ...
        $(document).on('click', '.menu-item-mega .sublimeplus-icon-down', function (e) {
            if($(window).width()<1024.98) {
                if (e.target !== this)
                    return;
                else {
        ...
        if (typeof  $.fn.slick != 'undefined') {
            $('.post-slider').slick({
                ...
                swipe: true,
                dots: true,
                prevArrow: '<span class="sublimeplus-carousel-btn prev-item"><i class="cs-font clever-icon-arrow-left"></i></span>',
                nextArrow: '<span class="sublimeplus-carousel-btn next-item "><i class="cs-font clever-icon-arrow-right"></i></span>',
            });
        }
        ...
        if (zooThemeSettings.enable_dev_mode === '1') {
            ...
            if (!$('#sublimeplus-theme-dev-actions').length) {
                $body.append('<div id="sublimeplus-theme-dev-actions"></div>');
            }
            ...
            if (zooThemeSettings.isRtl || $body.hasClass('rtl')) {
                $('#sublimeplus-theme-dev-actions').append('<a class="button action-link" href="' + currentUrl + queryMark + 'text-direction=ltr">LTR</a>');
            } else {
                $('#sublimeplus-theme-dev-actions').append('<a class="button action-link" href="' + currentUrl + queryMark + 'text-direction=rtl">RTL</a>');
            }
        }
    ...
    function Sublimeplus_back_to_top() {
        $(window).on('load',function () {
            if ($('#sublimeplus-back-to-top')[0]) {
                let $toTopButton = $('#sublimeplus-back-to-top');
                ...
                $(document).on('click', '#sublimeplus-back-to-top', function (e) {
                    e.preventDefault();
                    $('html, body').animate({
                        scrollTop: 0
                    }, 700);
