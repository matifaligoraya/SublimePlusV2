<?php
/**
 * Sublimeplus_WXR_Parser
 */
final class Sublimeplus_WXR_Parser
{
    private $wp_tags = [
     ...
     * @var string
     */
    private $base_dir = SUBLIMEPLUS_DIR . '/inc/sample-data/base';
    ...
    protected function simpleXmlParse($file)
    {
        ...
        foreach ($xml->channel->item as $item) {
            ...
            if ($this->isImage($wp) && !$is_logo) {
                ...
                $post['attachment_url'] = SUBLIMEPLUS_URI . 'core/assets/images/placeholder.png';
            }
