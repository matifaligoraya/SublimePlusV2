<?php
/**
 * Sublimeplus_WXR_Importer
 *
 * @package SublimePulse\Core\Admin\Migration
 * @author   SublimePulse
 * @link     https://bitandbytelab.com/
 *
 */

final class Sublimeplus_WXR_Importer
{
    /**
     * @var object
     */
    ...
    {
        $this->parser = new Sublimeplus_WXR_Parser();
    }
        ...
        if ($is_image) {
            if (!$is_logo) {
                if (!$file_content) {
                    ...
                    $file_content = $wp_filesystem->get_contents(SUBLIMEPLUS_DIR.'core/assets/images/placeholder.png');
                }
