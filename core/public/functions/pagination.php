 ...
 * Default pagination
 */
if (!function_exists('Sublimeplus_ajax_pagination'))
{
    function Sublimeplus_ajax_pagination(WP_Query $query = null, array $args = array())
    {
        ...
        $args = array(
            ...
            'container_selector'   => !empty($args['container_selector']) ? $args['container_selector'] : '.sublimeplus-container',
            ...
            'gutter'               => '',
            'column_width'         => '',
            'more_text'            => !empty($args['more_text']) ? $args['more_text'] : apply_filters('Sublimeplus_ajax_pagination_more_text', esc_html__('Load More', 'sublimeplus')),
            'no_more_text'         => !empty($args['no_more_text']) ? $args['no_more_text'] : apply_filters('Sublimeplus_ajax_pagination_no_more_text', esc_html__('No More Posts', 'sublimeplus')),
        );
        ...
        echo '<div id="spinner-'.esc_attr($uid).'" class="align-center hidden">' . apply_filters('Sublimeplus_ajax_pagination_spinner', '<img aria-hidden="true" role="presentation" src="'.SUBLIMEPLUS_URI.'core/assets/icons/spinner.svg'.'" width="48" height="48">') . '</div>';

        ?><div id="sublimeplus-pagination-<?php echo esc_attr($uid) ?>" class="sublimeplus-pagination"><?php
        ...
        $inline_scripts = 'jQuery(document).ready( function($) {
    		...
    		var ias = $.ias({
                ...
                pagination: "#sublimeplus-pagination-'.esc_attr($uid).'",
