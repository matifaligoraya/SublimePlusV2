...
/**
 * Add custom fields to menu items (admin + public — needed in both contexts)
 */
if (!function_exists('sublimeplus_menu_item_custom_fields')) {
 ...
 * Save custom fields
 */
if (!function_exists('sublimeplus_update_menu_item')) {
