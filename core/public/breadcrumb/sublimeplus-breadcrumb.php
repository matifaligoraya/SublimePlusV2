 ...
 *
 * @package SublimePulse\Core\Public\Classes
 * @author   SublimePulse
 * @link     https://bitandbytelab.com/
 *
 */
final class Sublimeplus_Breadcrumb
{
    /**
    ...
    function render(\WP_Query $query)
    {
        ...
        if (!empty($this->separator)) {
            $this->separator = '<span role="presentation" class="sublimeplus-breadcrumb-separator"><i class="' . esc_attr($this->separator) . '"></i></span>';
        } else {
            $this->separator = '<span role="presentation" class="sublimeplus-breadcrumb-separator"></span>';
        }
        $allow_html = array('span' => array('class' => array(), 'role' => array()), 'i' => array('class' => array()), 'a' => array('href' => array(), 'class' => array(), 'title' => array()));
        ?>
        <div class="sublimeplus-breadcrumb-container">
        <span>
                <a class="sublimeplus-breadcrumb-url sublimeplus-breadcrumb-home" href="<?php echo esc_url(home_url('/')) ?>">
                    <?php
                    if (!$this->home_title) {
                        if ( ! $this->home_icon ) {
    ...
    {
        return '<a class="sublimeplus-breadcrumb-url" href="' . $url . '">' . htmlspecialchars($anchor, ENT_QUOTES) . '</a>';
    }
