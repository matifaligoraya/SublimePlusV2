<?php
/**
 * Sublimeplus_Customize_Control_Media
 *
 * @package SublimePulse\Core\Customize\Classes\Controls
 *
 */
class Sublimeplus_Customize_Control_Media extends Sublimeplus_Customize_Control_Default
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-sublimeplus-customize-control-media">
        <#
        var required = '';
