<?php
/**
 * Sublimeplus_Customize_Control_Styling
 *
 * @package SublimePulse\Core\Customize\Classes\Controls
 *
 */
final class Sublimeplus_Customize_Control_Styling extends Sublimeplus_Customize_Control_Modal
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-sublimeplus-customize-control-styling">
        <#
        var required = '';
        ...
        <div class="sublimeplus-customize-control-settings-inner">
            <input type="hidden" class="sublimeplus-hidden-modal-input sublimeplus-only" data-name="{{ data.name }}" value="{{ JSON.stringify( data.value ) }}" data-default="{{ JSON.stringify( data.default ) }}">
        </div>
        </div>
        </script>
        <script type="text/html" id="tmpl-sublimeplus-modal-settings">
            <div class="sublimeplus-modal-settings">
                <div class="sublimeplus-modal-settings--inner">
                    <div class="sublimeplus-modal-settings--fields"></div>
                </div>
            </div>
        </script>
        <?php
