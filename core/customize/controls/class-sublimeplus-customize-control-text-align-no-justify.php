<?php
/**
 * Sublimeplus_Customize_Control_Text_Align_No_Justify
 *
 * @package SublimePulse\Core\Customize\Classes\Controls
 *
 */
final class Sublimeplus_Customize_Control_Text_Align_No_Justify extends Sublimeplus_Customize_Control_Default
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-sublimeplus-customize-control-text_align_no_justify">
        <#
        var required = '';
