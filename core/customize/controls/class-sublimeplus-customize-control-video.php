<?php
/**
 * Sublimeplus_Customize_Control_Video
 *
 * @package SublimePulse\Core\Customize\Classes\Controls
 *
 */
final class Sublimeplus_Customize_Control_Video extends Sublimeplus_Customize_Control_Media
{
    /**
     * Print template
     */
    ...
    {
        ?>
        <script type="text/html" id="tmpl-sublimeplus-customize-control-video">
        <#
        var required = '';
