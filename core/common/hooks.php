 ...
 *
 * @package SublimePulse\Core\Common
 * @author   SublimePulse
 ...
 */
if (!function_exists('Sublimeplus_ajax_get_wishlist_items')) {
    function Sublimeplus_ajax_get_wishlist_items()
    {
        ...
        if ($query->have_posts()) : ?>
            <h2 class="wishlist-panel-title sublimeplus-popup-panel-title"><?php echo esc_html__('My Wishlist', 'sublimeplus') ?></h2>
            <div class="sublimeplus-wrap-popup-content">
                <table class="wishlist-items-table">
                    ...
                    <tr>
                        ...
                        <?php if (!Sublimeplus_enable_catalog_mod()) {
                            ?>
                    ...
                    <?php while ($query->have_posts()) : $query->the_post();
                        ...
                        <tr id="wishlist-item-row-<?php echo esc_attr(get_the_ID()); ?>">
                            ...
                            <?php
                            if (!Sublimeplus_enable_catalog_mod()) {
                                ?>
    ...
    add_action('wp_ajax_Sublimeplus_get_wishlist_products', 'Sublimeplus_ajax_get_wishlist_items');
    add_action('wp_ajax_nopriv_Sublimeplus_get_wishlist_products', 'Sublimeplus_ajax_get_wishlist_items');
}

/**
 * AJAX get compare products
 */
if (!function_exists('Sublimeplus_ajax_get_compare_items')) {
    function Sublimeplus_ajax_get_compare_items()
    {
        ...
        if ($query->have_posts()) : ?>
            <h2 class="products-compare-panel-title sublimeplus-popup-panel-title">
                        ...
                        <?php while ($query->have_posts()) : $query->the_post(); ?>
                            <td class="product-remove products-compare-row-<?php echo esc_attr($post->ID); ?>">
                                <a href="#" class="remove-from-products-compare"
                                   title="<?php echo esc_attr__('Remove', 'sublimeplus'); ?>"
                                   data-id="<?php echo esc_attr($post->ID); ?>"><i class="sublimeplus-icon-close"></i></a>
                            </td>
                        <?php endwhile; ?>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <?php while ($query->have_posts()) : $query->the_post(); ?>
                            <td class="product-rating products-compare-row-<?php echo esc_attr($post->ID); ?>">
                                <?php do_action('Sublimeplus_woo_loop_rating'); ?>
                            </td>
                        <?php endwhile; ?>
                    </tr>
                    <tr>
    ...
    add_action('wp_ajax_Sublimeplus_get_compare_products', 'Sublimeplus_ajax_get_compare_items');
    add_action('wp_ajax_nopriv_Sublimeplus_get_compare_products', 'Sublimeplus_ajax_get_compare_items');
}
