 ...
 * CSS Functionality
 *
 * @package SublimePulse\Core\Functions
 * @author   SublimePulse
 ...
 * @return  string
 */
function Sublimeplus_css__minify($css)
{
    if (!trim($css))
        return '';
 ...
 */
function Sublimeplus_hex2rgba($hex, $opacity = 1)
{
    $hex = str_replace("#", "", $hex);
 ...
 * @return  string
 */
function Sublimeplus_px2rem($var)
{
    $body_font = get_theme_mod('Sublimeplus_typo_body_font');
    $base = apply_filters( 'Sublimeplus_body_font_size', 16 );
 ...
 * @return  string
 */
function Sublimeplus_generate_css_color($class, $var)
{
    if ($var != '') {
        $color = $class . '{';
        $color .= "color: " . $var . ";}";
...
function Sublimeplus_generate_css_font_size($class, $var)
{
    $font = $class . '{';
    $font .= "font-size: " . Sublimeplus_px2rem((int)str_replace(' ', 'px', $var)) . ";}";
    return $font;
}
 ...
 * @return  string
 */
function Sublimeplus_generate_css_font($class, $var)
{
    $font = '';
    ...
    if (isset($var['font-size']))
        $font .= "font-size: " . Sublimeplus_px2rem((int)str_replace(' ', 'px', $var['font-size'])) . ";";
 ...
 * @return  string
 */
function Sublimeplus_import_google_fonts(array $list_fonts, $load = true)
{
    $fonts_url = '';
 ...
 * @return array
 */
function Sublimeplus_get_font_icons($prefix = '')
{
    $fonts = [
        ...
        'sublimeplus-icon' => ['sublimeplus-icon-menu','sublimeplus-icon-cart','sublimeplus-icon-heart','sublimeplus-icon-heart-o','sublimeplus-icon-refresh','sublimeplus-icon-user','sublimeplus-icon-search','sublimeplus-icon-filter','sublimeplus-icon-close','sublimeplus-icon-plus','sublimeplus-icon-minus','sublimeplus-icon-up','sublimeplus-icon-down','sublimeplus-icon-caret-up','sublimeplus-icon-caret-down','sublimeplus-icon-arrow-up','sublimeplus-icon-arrow-down','sublimeplus-icon-arrow-left','sublimeplus-icon-arrow-right'],
    ];
