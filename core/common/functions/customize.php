 ...
 *
 * @package SublimePulse\Core\Customize\Functions
 * @author   SublimePulse
 ...
 */
function Sublimeplus_customize_get_all_config(WP_Customize_Manager $wp_customize = null)
{
    static $configs = null;

    if (null === $configs) {
        $filtered_configs = apply_filters('zoo/customizer/config', [], $wp_customize);
        if (file_exists(SUBLIMEPLUS_DIR.'inc/customize/customize.php')) {
            $theme_configs = require SUBLIMEPLUS_DIR.'inc/customize/customize.php';
 ...
 * @return  array
 */
function Sublimeplus_customize_get_panel_setting($panel_id)
{
    $options = array_merge([
        'desktop' => '',
        'mobile'  => '',
    ], (array)Sublimeplus_customize_get_setting($panel_id, 'all'));
 ...
 * @return  mixed
 */
function Sublimeplus_customize_get_setting($name, $device = 'desktop', $key = '', $default_only = false)
{
    $get_value = $value = null;
    $page_id   = Sublimeplus_get_current_page_id();
    $configs   = Sublimeplus_customize_get_all_config();
 ...
 */
function Sublimeplus_customize_get_attachment($value, $size = 'full')
{
    if (empty($value)) {
        return false;
    }
