    ...
    var ZooProductsCompareView = (function () {
        ...
        Constructor.prototype.renderPanel = function (content) {
            ...
            if (this.panel.length) {
                ...
                $('body').append('<div class="products-compare-panel sublimeplus-popup-panel" style="display:none"><div class="popup-mask-close loading"></div><button class="products-compare-panel-close-btn popup-close-btn" type="button" name="close-button"><i class="sublimeplus-icon-close"></i></button><div class="products-compare-panel-inner sublimeplus-popup-inner">' + content + '</div></div>');
            }
        }
        ...
        Constructor.prototype.renderBrowseButton = function (btn) {
            ...
            btn = $('.sublimeplus-compare-button[data-id='+btn.data('id')+']');
    ...
    var ZooProductsCompareController = (function () {
        ...
        Constructor.prototype.sync = function (changeEvent) {
            ...
            if ('zooProductsCompareItems' === changeEvent.key) {
                ...
                if (items.length < 1) {
                    $('.products-compare-counter').addClass('sublimeplus-hidden');
                }
            }
        };
        ...
        Constructor.prototype.browseAction = function (browseEvent) {
            ...
            if (items.length && !this.doingAJAX) {
                ...
                $.ajax({
                    ...
                    self.view.panel.find('.sublimeplus-popup-inner').fadeIn();
