(function ($, window, wp) {
    ...
    $(".sublimeplus-theme-settings .nav-item").on("click", function(e)
    {
        e.preventDefault();
        ...
        activeItem = $(this);
        items = $(".sublimeplus-theme-settings .nav-item");
        tabs = $(".sublimeplus-theme-settings .tab-table");
     ...
     * Handle demo actions
     */
    DOC.on('click', '.sublimeplus-theme-setup-site-demo .demo-import', function(e) {
        var btn = $(this),
            demo = btn.data('style'),
