...
(function($, exports)
{
    ...
    var ZooLiveCss = (function()
    {
        ...
        Ctor.prototype.render = function(fieldName)
        {
            ...
            if ($('#sublimeplus-google-font-css').length <= 0) {
                $('head').prepend('<link rel="stylesheet" id="sublimeplus-google-font-css" href="" media="all">');
            }

            if (url) {
                $('#sublimeplus-google-font-css').attr('href', url);
            } else {
                $('#sublimeplus-google-font-css').remove();
            }

            css_code = css_code.trim();

            if ($('#sublimeplus-style-inline-css').length <= 0) {
                $('head').append("<style id='sublimeplus-style-inline-css' type='text/css'></style>")
            }

            $('#sublimeplus-style-inline-css').html(css_code);
